...
public final class KoreanStockTickSizePolicy {
    ...
    public static BigDecimal tickSizeForCurrentPrice(String market, BigDecimal currentPrice) {
        return tickSizeForQuotePrice(market, currentPrice);
    }

    public static BigDecimal tickSizeForQuotePrice(String market, BigDecimal quotePrice) {
    ...
    public static boolean isValidQuotePrice(String market, BigDecimal quotePrice) {
    ...
    public static BigDecimal ceilingValidQuotePrice(String market, BigDecimal rawPrice) {
        return alignToValidQuotePrice(market, rawPrice, RoundingMode.CEILING);
    }

    public static BigDecimal floorValidQuotePrice(String market, BigDecimal rawPrice) {
