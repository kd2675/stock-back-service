...
final class AutoParticipantProfileConfigDefaults {
    ...
    static AutoParticipantFundingPolicyDefaults fundingDefaults() {
        return AutoParticipantFundingPolicyDefaults.NO_RECURRING_FUNDING;
    }
    ...
    static AutoParticipantProfileExitMode exitModeFor(AutoParticipantProfileType profileType) {
        return switch (profileType) {
            case PROFIT_LOCKER -> AutoParticipantProfileExitMode.TAKE_PROFIT_FIRST;
            case LONG_TERM_HOLDER, PAYDAY_ACCUMULATOR, DIVIDEND_REINVESTOR, LIMIT_DOWN_TRAPPED ->
                    AutoParticipantProfileExitMode.HOLD_LOSSES;
            default -> AutoParticipantProfileExitMode.SIGNAL_DRIVEN;
        };
    }
    ...
    private static Map<AutoParticipantProfileType, ProfileConfigDefaults> createDefaults() {
        ...
        defaults.put(AutoParticipantProfileType.NEWS_REACTIVE, profileDefaults(0.85, 0.15, 0.00, 0.25, 0.20, 0.00, 0.10, 0.10, 0.00, 0.05, 1.10, 1.15, 1.00, 1.00, 0.15, 0.10, 0.20));
        defaults.put(AutoParticipantProfileType.MOMENTUM_FOLLOWER, profileDefaults(0.25, 0.85, 0.00, 0.20, 0.35, 0.00, 0.15, 0.12, 0.05, 0.00, 1.00, 1.10, 1.00, 1.00, 0.10, 0.05, 0.25));
        defaults.put(AutoParticipantProfileType.CONTRARIAN, profileDefaults(0.20, 0.00, 0.85, 0.25, 0.00, 0.10, 0.05, 0.12, 0.00, 0.35, 1.00, 0.90, 1.20, 1.00, 0.20, 0.15, 0.35));
        ...
        defaults.put(AutoParticipantProfileType.DAY_TRADER, profileDefaults(0.25, 0.62, 0.00, 0.08, 0.30, 0.00, 0.20, 0.18, 0.12, 0.00, 1.20, 1.15, 0.80, 0.85, 0.00, 0.00, 0.80));
        defaults.put(AutoParticipantProfileType.SWING_TRADER, profileDefaults(0.30, 0.45, 0.25, 0.25, 0.15, 0.00, 0.15, 0.12, 0.05, 0.20, 0.95, 1.05, 1.10, 1.05, 0.20, 0.15, 0.45));
        defaults.put(AutoParticipantProfileType.LONG_TERM_HOLDER, profileDefaults(0.20, 0.05, 0.20, 0.85, 0.00, 0.00, 0.00, 0.05, 0.00, 0.45, 0.45, 0.50, 2.50, 0.55, 0.95, 0.75, 0.05));
        defaults.put(AutoParticipantProfileType.PAYDAY_ACCUMULATOR, profileDefaults(0.20, 0.10, 0.15, 0.65, 0.05, 0.00, 0.00, 0.06, 0.00, 0.55, 0.90, 0.80, 2.00, 0.70, 0.90, 0.55, 0.05));
        defaults.put(AutoParticipantProfileType.DIVIDEND_REINVESTOR, profileDefaults(0.20, 0.08, 0.20, 0.70, 0.05, 0.00, 0.00, 0.05, 0.00, 0.50, 0.80, 0.75, 2.20, 0.65, 0.90, 0.65, 0.08));
        defaults.put(AutoParticipantProfileType.LIMIT_DOWN_TRAPPED, profileDefaults(0.20, 0.00, 0.20, 1.00, 0.05, 0.00, 0.00, 0.08, 0.00, 0.25, 0.55, 0.55, 2.50, 0.50, 1.00, 1.00, 0.00));
        defaults.put(AutoParticipantProfileType.AVERAGE_DOWN_BUYER, profileDefaults(0.20, 0.00, 0.55, 0.80, 0.05, 0.00, 0.00, 0.08, 0.00, 0.95, 1.05, 0.90, 1.80, 1.20, 0.75, 0.35, 0.05));
        defaults.put(AutoParticipantProfileType.STOP_LOSS_TRADER, profileDefaults(0.25, 0.35, 0.00, 0.00, 0.20, 0.00, 0.05, 0.18, 0.80, 0.00, 1.20, 1.25, 0.55, 0.95, 0.00, 0.10, 0.65));
        defaults.put(AutoParticipantProfileType.FOMO_BUYER, profileDefaults(0.35, 0.85, 0.00, 0.05, 0.65, 0.00, 0.35, 0.18, 0.05, 0.00, 1.00, 1.10, 0.90, 1.00, 0.05, 0.00, 0.25));
        defaults.put(AutoParticipantProfileType.PANIC_SELLER, profileDefaults(0.25, 0.22, 0.00, 0.22, 0.38, 0.00, 0.08, 0.16, 0.82, 0.00, 0.95, 1.05, 0.90, 0.95, 0.00, 0.00, 0.62));
        defaults.put(AutoParticipantProfileType.DIP_BUYER, profileDefaults(0.25, 0.00, 0.65, 0.35, 0.10, 0.00, 0.05, 0.15, 0.00, 0.90, 1.15, 1.05, 0.80, 1.00, 0.25, 0.25, 0.20));
        defaults.put(AutoParticipantProfileType.PROFIT_LOCKER, profileDefaults(0.20, 0.35, 0.00, 0.10, 0.15, 0.00, 0.05, 0.20, 0.05, 0.00, 1.35, 1.25, 0.55, 0.85, 0.00, 0.95, 1.00));
        defaults.put(AutoParticipantProfileType.LIQUIDITY_AVOIDANT, profileDefaults(0.20, 0.10, 0.00, 0.35, 0.00, 0.00, 0.00, 0.05, 0.10, 0.00, 0.55, 0.55, 1.80, 0.60, 0.25, 0.10, 0.35));
        defaults.put(AutoParticipantProfileType.CASH_DEFENSIVE, profileDefaults(0.15, 0.05, 0.15, 0.50, 0.00, 0.00, 0.00, 0.04, 0.10, 0.10, 0.35, 0.45, 2.20, 0.35, 0.70, 0.20, 0.20));
        defaults.put(AutoParticipantProfileType.WHALE, profileDefaults(0.30, 0.35, 0.00, 0.20, 0.25, 0.00, 0.20, 0.10, 0.05, 0.00, 1.20, 0.85, 1.20, 1.80, 0.05, 0.00, 0.30));
        defaults.put(AutoParticipantProfileType.SMALL_DIVERSIFIER, profileDefaults(0.25, 0.20, 0.10, 0.30, 0.10, 0.00, 0.05, 0.10, 0.00, 0.05, 1.20, 0.70, 1.20, 0.45, 0.25, 0.15, 0.25));
        defaults.put(AutoParticipantProfileType.OBSERVER, profileDefaults(0.15, 0.10, 0.00, 0.20, 0.00, 0.00, 0.00, 0.03, 0.00, 0.00, 0.30, 0.40, 2.20, 0.40, 0.10, 0.00, 0.10));
