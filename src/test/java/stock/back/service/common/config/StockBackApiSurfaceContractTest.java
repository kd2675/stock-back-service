...
class StockBackApiSurfaceContractTest {
    ...
    private static final Set<String> EXPECTED_STOCK_API_SURFACE = Set.of(
            ...
            "POST /api/stock/v1/markets/liquidity-mandates/{symbol}/scaled-shadow",
            "POST /api/stock/v1/markets/liquidity-mandates/{symbol}/activate",
            "POST /api/stock/v1/markets/underwriting-contracts/{contractId}/scaled-supply/activate",
            "POST /api/stock/v1/markets/underwriting-contracts/{contractId}/scaled-supply/suspend",
